    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <section aria-labelledby="stats-heading">
        ...
        <div className="mt-3 grid grid-cols-2 gap-3 sm:grid-cols-4">
          ...
          <StatCard label="Active" value={overview.inProgress} accent="text-grace-info" />
          <StatCard label="Resolved" value={overview.resolved} accent="text-grace-success" />
          <StatCard label="SLA At Risk" value={overview.slaAtRisk} accent="text-grace-warning" />
        </div>
      </section>
